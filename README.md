...
| Parameter | Function |
| :----: | --- |
| `AUTOPAUSE` | pause game when no player is connected |
| `AUTOSAVEINTERVAL` | autosave interval in seconds |
| `AUTOSAVENUM` | number of rotating autosave files |
| `AUTOSAVEONDISCO` | autosave when last player disconnects |
